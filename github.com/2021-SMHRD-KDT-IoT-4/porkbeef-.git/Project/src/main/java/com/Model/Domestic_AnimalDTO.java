...
public Domestic_AnimalDTO(int room, int product_cnt, String receving_date, String forwarding_date, String fir_vaccine,
		String sec_vaccine, String thr_vaccine, int enableGrade) {
	super();
	this.room = room;

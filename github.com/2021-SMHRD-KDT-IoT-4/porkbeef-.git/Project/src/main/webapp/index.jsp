			...
			<tr>
				<td>
					<section class="4u">
						...
						<span class= "box">가까운 백신접종일</span>
							<span class= "box"><%=nearVacDate.format(DateTimeFormatter.ofPattern("yyyy년MM월dd일")) %></span>
					</section>
				</td>
				...
				<td>
					<section class="4u">
						...
						<span class= "box">가까운 출하예정일</span>
							<span class= "box"><%=nearForwadDate.format(DateTimeFormatter.ofPattern("yyyy년MM월dd일")) %></span>
					</section>
				</td>
			</tr>
		</table>
